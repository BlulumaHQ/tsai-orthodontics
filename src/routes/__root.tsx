  ...
  head: () => ({
    meta: [
      ...
      { title: "Tsai Orthodontics — Specialist Orthodontic Care, Vancouver" },
      {
        name: "description",
        content:
          "Boutique specialist orthodontics for Vancouver families. Braces, Invisalign, and considered care for children, teens, and adults.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,500;0,600;1,500;1,600&family=Inter:wght@300;400;500;600&display=swap",
      },
    ],
    scripts: [
      {
